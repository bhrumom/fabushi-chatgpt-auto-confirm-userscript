...
| R7 | verified | `npm test`: 218 total, 211 passed, 0 failed, 7 skipped; syntax check and `git diff --check` pass. Real Chrome reload/resume still needs live acceptance. |
