...
| CAR-012 | 连接中断首次及后续 3 次刷新统一为 15 分钟，3/3 后仍原会话续发 | I1-I10 | source regression + CI + main readback | cancelled / superseded by CAR-013 |
| CAR-013 | 更正 15 分钟范围：generic stall 保持 15 分钟，连接中断恢复恢复 10 秒节流 | J1-J8 | source regression + CI + userscript/host Releases | in-progress |
