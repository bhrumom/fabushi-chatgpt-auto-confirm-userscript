...
| CAR-010 | 修复 same-route 加载恢复导致 scheduler 静默停止并保持 1/2->2/2 计数 | G1-G8 | source regression + CI + userscript/host Releases | done (PR #45 / v2.9.45 / host v0.6.19 via v2.9.46 superset) |
| CAR-011 | 通用会话无变化刷新间隔由 3 分钟改为 15 分钟，显式错误恢复保持原节奏 | H1-H7 | source regression + CI + userscript/host Releases | done (PR #46 / v2.9.46 / host v0.6.19) |
