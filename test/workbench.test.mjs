...
test('the packaged userscript declares its stable remote update and download URLs',()=>{
  ...
  assert.match(source,/const CONNECTION_INTERRUPTED_REFRESH_COOLDOWN_MS = 10 \* 1000/);
  assert.doesNotMatch(source,/CONNECTION_INTERRUPTED_REFRESH_COOLDOWN_MS = 15 \* 60 \* 1000/);
